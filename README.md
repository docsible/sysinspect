...
|--------------|--------------|-------------|-------------|-------------|
| [sysinspect_debug_mode](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L10)   | bool   | `True` |    false  |  Enable debug mode for detailed output |
| [sysinspect_report_output_path](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L17)   | str   | `/tmp/system_report.json` |    true  |  Output path for system report |
| [sysinspect_report_webhook_url](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L23)   | str   |  |    false  |  Send report to webhook |
| [sysinspect_collect_hardware](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L29)   | bool   | `True` |    true  |  Collect CPU, memory, and disk usage |
| [sysinspect_collect_os](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L35)   | bool   | `True` |    true  |  Collect OS, kernel, and uptime info |
| [sysinspect_collect_network](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L40)   | bool   | `True` |    true  |  Collect network information (IP addresses) |
| [sysinspect_cpu_alert_threshold](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L45)   | int   | `90` |    false  |  CPU usage alert threshold |
| [sysinspect_memory_alert_threshold](https://github.com/docsible/sysinspect/blob/main/defaults/main.yml#L50)   | int   | `90` |    false  |  Memory usage alert threshold |
<details>
...
| ---- | ------ | --------- |  -------- |
| [Run metric shell command for {{ metric_name }}](https://github.com/docsible/sysinspect/blob/main/tasks/collect_metric.yml#L5) | ansible.builtin.shell | True | tasks file for sysinspect |
| [Transfer result to dynamic register var](https://github.com/docsible/sysinspect/blob/main/tasks/collect_metric.yml#L15) | ansible.builtin.set_fact | True |  |

#### File: tasks/main.yml

| Name | Module | Has Conditions | Comments |
| ---- | ------ | --------- |  -------- |
| [Begin system diagnostics](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L5) | ansible.builtin.debug | False | tasks file for sysinspect |
| [Initialize data dictionary](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L9) | ansible.builtin.set_fact | False |  |
| [Collect hardware metrics](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L14) | block | False | --- Hardware Block --- |
| [Collect CPU usage](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L17) | ansible.builtin.include_tasks | False | Collect CPU usage |
| [Collect memory usage](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L26) | ansible.builtin.include_tasks | False | Collect memory usage |
| [Collect disk usage](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L35) | ansible.builtin.import_tasks | False | Collect disk usage |
| [Set hardware facts](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L43) | ansible.builtin.set_fact | True |  |
| [Collect OS metrics](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L60) | block | False | --- OS Block --- |
| [Get OS version](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L62) | ansible.builtin.import_tasks | False |  |
| [Get kernel version](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L70) | ansible.builtin.include_tasks | False |  |
| [Get uptime](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L78) | ansible.builtin.include_tasks | False |  |
| [Set OS facts](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L86) | ansible.builtin.set_fact | True |  |
| [Collect network info](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L102) | block | False | --- Network Block --- |
| [Get main IP address](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L104) | ansible.builtin.include_tasks | False |  |
| [Set network fact](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L112) | ansible.builtin.set_fact | True |  |
| [Check threshold alerts](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L123) | block | False | --- Resource Threshold Alerts --- |
| [Alert on high CPU](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L125) | ansible.builtin.debug | True |  |
| [Alert on high memory](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L130) | ansible.builtin.debug | True |  |
| [Append role configuration to report data](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L141) | ansible.builtin.set_fact | False | --- Include Configuration Parameters into Report --- |
| [Show final system report JSON (debug mode)](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L157) | ansible.builtin.debug | True | --- Debug Final Report --- |
| [Write system report to JSON file](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L163) | ansible.builtin.copy | False | --- Output JSON --- |
| [Send report to webhook](https://github.com/docsible/sysinspect/blob/main/tasks/main.yml#L170) | ansible.builtin.uri | True | --- Send to webhook if URL is defined --- |
